...
export const productData = [
  ...
  },
  {
    ...
    desc: "Mariana sauce, basil, ham, pepperori, pineapples and onions",
    price: "$16.99",
    button: "Add to Cart",
  },
  {
    ...
    desc: "Mariana sauce, basil, beef, lettuce, roma tomatoes, olives, and pesto",
    price: "$14.99",
    button: "Add to Cart",
  },
];
...
export const productDataTwo = [
  {
    ...
    alt: "Donuts",
    name: "Doughlicious",
    desc: "Belgium chocolate glazed donuts covered in icing with sprinkles on top",
    price: "$9.99",
    button: "Add to Cart",
  },
  {
